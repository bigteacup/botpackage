...
public class CalculsTravian2 {

	Travian t;
	public CalculsTravian2() {
	...
	public static void main(String[] args) throws ParseException {
			...
			double dist = c.calculDeDistance(76, -2, 258, -93 ,true);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public double calculDeDistance(double xa,double ya,double xb,double yb, boolean verbose ) throws ParseException {
		...
		if(verbose ==true){	System.out.println("Raw Distance = "+distance);}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public double arrondirADeuxChiffres(double x,boolean verbose) throws ParseException{
        ...
        if(verbose ==true){   System.out.println("Distance Arrondie = "+number);}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(verbose ==true){	System.out.println("Temps de trajet : "+heureTravian+"   et chriffre de base : "+a);}
...
// Partie calculs
if(distance>20){a=((2060.0)/(vitesseTroupeartefact))+(((distance-20)60.0)/((((vitesseTroupe)(((placeTournoi+bottes)/100.0))))(artefact)));}else{a=(distance60.0)/(vitesseTroupe*artefact);}

double Partie_calcul() {
	init_variables();
	double resultat = vitesse_distance_de_base(distance) + vitesse_distance_bonus(distance);
	// log4j.debug("class CalculsTravian2 ; Partie_calcul() ; resultat = " +
	// resultat);
	return resultat;
}
...
double vitesse_distance_de_base(double distance) {
	return (distance60.0)/(vitesseTroupeartefact) ;
}

double vitesse_distance_bonus(double distance) {
	if (distance>20){ 

		return vitesse_distance_de_base(distance - 20 )    /( (placeTournoi + bottes) /100.0) ) ;
	}
	else 
		return (double) 0.0 ;
}return new Double(0).parseDouble();
