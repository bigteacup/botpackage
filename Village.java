	...
	public boolean construireBatiments(String batimentAConstruire, int levelVoulu, Travian t) {
		...
		for (WebElement webBatiment : listeDesBatiments) {
			try {
				...
				}catch(Exception e){/* t.ecrireDansConsole("Echec levelSuivantDispo de construire batiment");*/} //Coût pour le niveau 8:
										...
										for (WebElement webBat : listWebBats) {
											...
											if (titre.toLowerCase().contains(nomBat.toLowerCase())) {
												...
												try {
													...
													t.ecrireDansConsole(nomBat + " --> echec Pas dispo à la construction sur page manque ressources ou prerequis "+ i2 +" Debug info : "+" nomBat ="+nomBat+" Titre.toLowerCase ="+ titre.toLowerCase() +" Titre normal ="+ titre );
													}
												}//fin catch
